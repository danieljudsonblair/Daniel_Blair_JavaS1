...
public class Comment {
    ...
    @Min(0)
    private int postId;
    @NotNull(message = "You must supply createDate in format YYYY-MM-DD")
    @JsonSerialize(using = LocalDateSerializer.class)
    @JsonDeserialize(using = LocalDateDeserializer.class)
    private LocalDate createDate;
    @NotNull(message = "You must supply a value for commenterName")
    @NotEmpty(message = "commenterName must not be empty")
    private String commenterName;
    @NotNull(message = "You must supply a value for comment")
